...
export default function InvoicesPage() {
  ...
  const filtersPanel = (
    <div className="space-y-3">
      <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider block">Invoice Status
        <select 
      ...
      <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider block">Bill Type
        <select 
              ...
              <tbody>
                {visible.map((x) => (
                  <tr key={x.id} className="border-b last:border-0 hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-4 py-3.5">
                      <span className="block font-bold text-foreground">{x.customerName}</span>
                      <span className="text-xs text-muted-foreground">{x.customerPhone}</span>
                    </td>
                    <td className="px-4 py-3.5">
                    ...
                    <td className="px-4 py-3.5 font-bold text-foreground">{fmt(x.totalAmount)}</td>
                    <td className="px-4 py-3.5 text-muted-foreground font-medium">{fmt(x.amountPaid)}</td>
