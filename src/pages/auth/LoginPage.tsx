    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-2">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-md overflow-hidden bg-card">
              ...
              {(["OWNER", "MANAGER", "STAFF"] as const).map((role) => {
                ...
                return (
                  <button
                    ...
                    className="px-2 py-2 bg-card hover:bg-muted border border-border text-muted-foreground rounded-lg text-[10px] font-bold cursor-pointer transition-all active:scale-[0.97] flex items-center justify-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSelectedLoading && (
