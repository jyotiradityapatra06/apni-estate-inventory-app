                ...
                {section.items.map((item, i) => {
                  ...
                  return (
                    <div key={item.label}>
                      ...
                      <button
                        onClick={() => {
                          if (item.label === "Business Profile") {
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3.5 text-left cursor-pointer animate-none"
                      >
                    ...
                    return (
                      <div key={item.label}>
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-4 py-3.5 text-left cursor-pointer hover:bg-black/5 animate-none"
                        >
                          <div style={{ background: C.surface }} className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0">
                            <Icon size={15} color={C.muted} />
                          </div>
