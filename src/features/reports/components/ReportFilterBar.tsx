...
export const ReportFilterBar: React.FC<ReportFilterBarProps> = ({
  ...
  return (
    <div className="report-actions space-y-4 rounded-2xl border border-border bg-card p-4 shadow-2xs dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border pb-3 dark:border-slate-800">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onReset}
            className="flex min-h-9 items-center gap-1.5 rounded-xl border border-border bg-muted px-3 text-xs font-bold text-muted-foreground hover:bg-muted transition-colors cursor-pointer dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
          >
            <RotateCcw size={13} />
            Reset
          </button>
          <button
            onClick={onPrint}
            className="flex min-h-9 items-center gap-1.5 rounded-xl border border-border bg-card px-3 text-xs font-bold text-muted-foreground shadow-2xs hover:bg-muted transition-colors cursor-pointer dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
          >
            <Printer size={13} />
            Export PDF
          </button>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
        <div>
          <label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground dark:text-muted-foreground block mb-1">
            Date Preset
          </label>
          <select
        ...
        <div>
          ...
          <input
            ...
            className="w-full h-10 rounded-xl border border-border bg-card px-3 text-xs font-bold text-foreground focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 placeholder:text-muted-foreground dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
          />
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5 pt-1 border-t border-border dark:border-slate-800">
        {setMaterialId && (
          <div>
            <label className="text-[10px] font-black uppercase tracking-wider text-muted-foreground dark:text-muted-foreground block mb-1">
              Material Item
