...
export interface Supplier {
  ...
  alternatePhone?: string | null; email?: string | null; gstin?: string | null; state?: string | null; stateCode?: string | null; address?: string | null;
...
export interface SupplierInput {
  ...
  email?: string | null; gstin?: string | null; state?: string | null; stateCode?: string | null; address?: string | null; openingPayable: number;
